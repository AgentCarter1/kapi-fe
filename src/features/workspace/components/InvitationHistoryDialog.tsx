...
import { X, Clock, Mail, CheckCircle, XCircle, Ban } from "lucide-react";
import { useInvitationHistory } from "../api/invitationApi";
...
const InvitationHistoryDialog: React.FC<InvitationHistoryDialogProps> = ({
  isOpen,
  onClose,
  workspaceId,
  email,
}) => {
  const { data: history, isLoading, error } = useInvitationHistory(
    workspaceId,
    email
  );
            ...
            {!isLoading && !error && history && history.length === 0 && (
              <div className="text-center py-12">
                ...
                <p className="text-gray-600">
                  There are no previous invitation records for this email.
                </p>
              </div>
            )}
...
export default InvitationHistoryDialog;
