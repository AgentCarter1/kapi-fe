export const AdminDashboard = () => {
  return (
    <div>
      ...
      <p className="text-gray-600 text-lg mb-8">Welcome to the admin panel</p>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd className="text-lg font-medium text-gray-900">Manage Devices</dd>
                </dl>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd className="text-lg font-medium text-gray-900">Manage Workspaces</dd>
                </dl>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white overflow-hidden shadow rounded-lg">
          <div className="p-5">
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  <dt className="text-sm font-medium text-gray-500 truncate">Licenses</dt>
                  <dd className="text-lg font-medium text-gray-900">Manage Licenses</dd>
                </dl>
              </div>
            </div>
          </div>
